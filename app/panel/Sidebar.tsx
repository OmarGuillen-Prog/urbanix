...
const ITEMS_MENU: ItemMenu[] = [
  ...
  { label: "Usuarios", href: "/panel/usuarios", disponible: false, roles: ["administrador"] },
  { label: "Propiedades", href: "/panel/propiedades", disponible: false, roles: ["administrador", "residente"] },
